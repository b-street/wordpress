...
<span class="realtyna_floating_button">
        <a href="#" class="rfb-float rfb-btn" id="rfb-menu-share">
                ...
                <div class="rfb-label-container">
                        <div class="rfb-label-text"><?=__( "Need Help?" , REALTYNA_MLS_SYNC_SLUG );?></div>
        ...
        <ul>
                <li>
                        <a href="https://realtyna.com/" class="rfb-btn" target="_blank">
                                <i class="dashicons dashicons-paperclip rfb-floating"></i>
                                <div class="rfb-label-container">
                                        <div class="rfb-label-text"><?=__( "More Info" , REALTYNA_MLS_SYNC_SLUG );?></div>
                                        <i class="dashicons dashicons-controls-play rfb-label-arrow"></i>
                                </div>
                        </a>
                </li>
                ...
                <li>
                        <a href="https://support.realtyna.com/index.php?/Default/Tickets/Submit" class="rfb-btn" target="_blank">
                                ...
                                <div class="rfb-label-container">
                                        <div class="rfb-label-text"><?=__( "Create Ticket" , REALTYNA_MLS_SYNC_SLUG );?></div>
                                        <i class="dashicons dashicons-controls-play rfb-label-arrow"></i>
                                </div>
                        </a>
                </li>
                ...
                <li>
                        <a href="mailto:sync@realtyna.net" class="rfb-btn">
                                ...
                                <div class="rfb-label-container">
                                        <div class="rfb-label-text"><?=__( "Email Us" , REALTYNA_MLS_SYNC_SLUG );?></div>
                                        <i class="dashicons dashicons-controls-play rfb-label-arrow"></i>
                                </div>
                        </a>
                </li>
                ...
                <li>
                        <a href="tel:+13027225393" class="rfb-btn">
                                ...
                                <div class="rfb-label-container">
                                        <div class="rfb-label-text"><?=__( "Call Us" , REALTYNA_MLS_SYNC_SLUG );?></div>
                                        <i class="dashicons dashicons-controls-play rfb-label-arrow"></i>
                                </div>
                        </a>
                </li>
