...
<form action="admin.php" id="settings_form">
    ...
    <input type="hidden" name="page" value="<?=REALTYNA_MLS_SYNC_SLUG . '-settings'?>">
    ...
    <div class="realtyna_houzez_form">
        ...
        <i class="dashicons dashicons-admin-generic"></i> <?=__("Settings" , REALTYNA_MLS_SYNC_SLUG );?>
        </p>
        ...
        <p>
            ...
            <label for="apply_agent_display_option_to_all"><?=__("set this option to all imported properties" , REALTYNA_MLS_SYNC_SLUG );?></label>
        </p>
        <hr>
        ...
        <p>
            ...
            <label for="apply_agent_to_all"><?=__("set this agent to all imported properties" , REALTYNA_MLS_SYNC_SLUG );?></label>
        </p>
        <hr>
        ...
        <p>
            ...
            <label for="apply_agency_to_all"><?=__("set this agency to all imported properties" , REALTYNA_MLS_SYNC_SLUG );?></label>
        </p>
        <hr>
        ...
        <p class="realtyna_warning_text">
            <b><?=__("Note: changes of this option, whould be applied on new properties only." , REALTYNA_MLS_SYNC_SLUG );?></b>
        </p>
        <hr>
        ...
        ?>
        <div>				
            <a class="button " href="javascript:void(0);" id="realtyna_remove_demo_properties" onclick="return false;" ><?=__("Remove Demo Properties" , REALTYNA_MLS_SYNC_SLUG );?></a>
        </div>
        <?php
        }
        ?>
        ...
        <p>
            <button type="button" name="realtyna_submit_settings" id="realtyna_submit_settings" class="button button-primary "><?=__("Update Settings" , REALTYNA_MLS_SYNC_SLUG);?></button>
        </p>
