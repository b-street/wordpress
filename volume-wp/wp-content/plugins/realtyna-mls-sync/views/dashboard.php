...
<div class="wrap">
	...
	<div class="realtyna_houzez_form">
			<p class="realtyna_mls_sync_step_title">
				<i class="dashicons dashicons-dashboard"></i> <?=__("Dashboard" , REALTYNA_MLS_SYNC_SLUG );?>
			</p>
			...
			<div id="request_for_mls_box" class="realtyna_box_shadow" style="background-color: #ceebf5;padding-top:10px;padding-bottom:10px;border-radius:15px;">
				...
				<p>
					<b><?=__("Requested Provider", REALTYNA_MLS_SYNC_SLUG );?></b> :
				</p>

				<p>
					<input type="text" name="realtyna_request_provider" id="realtyna_request_provider" value="<?=$mlsData['name'];?>" disabled />
				</p>

				<p>
					<b><?=__("Current Status", REALTYNA_MLS_SYNC_SLUG );?></b> :
				</p>

				<p>
					<input type="text" name="realtyna_request_provider" id="realtyna_request_provider" value="<?php echo ucfirst( $mlsData['status'] ) ;?>" disabled />
				</p>
			...
			<p id="payment_details" class="realtyna_success_bg realtyna_success_text" style="text-align:center; margin:10px;padding:10px; font-weight:bold;">
                <?php
                    if ( $mlsData['id'] == 0 ){
                        ...
                        echo __( 'Your Request for MLS has been sent successfully!<br>Our team will contact you soon.<br>If you need more information you can contact us: sync@realtyna.net' , REALTYNA_MLS_SYNC_SLUG );
            ...
            <p>
                <a class="button button-secondary" href="<?=$mlsData['checkout']?>" ><?=__("Proceed With Payment" , REALTYNA_MLS_SYNC_SLUG);?></a>                
            </p>
            <?php
            endif;
            ?>
            ...
            ?>
			<p>
				<a class="button button-secondary" href="admin.php?page=<?=REALTYNA_MLS_SYNC_SLUG?>&reset_mls=1" ><?=__("Select Another MLS Provider" , REALTYNA_MLS_SYNC_SLUG);?></a>
			</p>
            <?php
            endif;
            ?>
